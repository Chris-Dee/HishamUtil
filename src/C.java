...
public static double eo=8.854187*EE(-14); //Dielectric Permittibity of Vacuum (F/cm)
...
public static double latticeSi=5.4037; //Lattice Consant in angstroms. rest are on 1.7
